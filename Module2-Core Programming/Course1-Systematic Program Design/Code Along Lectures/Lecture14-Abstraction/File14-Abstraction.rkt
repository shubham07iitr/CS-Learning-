...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname File14-Abstraction) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (contains? "UBC" (cons "UBC" empty)) true)
(check-expect (contains? "UBC" (cons "McGill" (cons "UBC" empty))) true)
(check-expect (contains? "Toronoto" (cons "UBC" (cons "McGill" empty))) false)
...
(check-expect (map2 abs (list -2 -3 4 5)) (list 2 3 4 5))
