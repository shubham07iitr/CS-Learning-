...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname File13-Encapsulation) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; ListOfElement -> ListOfString ;; not necessary after encapsulation
;; produce list of the names of all the elements in the tree
;(check-expect (all-names--loe empty) empty) ;; not needed after encapsulation
...
;(define (all-names e) empty) ;stubs
;(define (all-names--loe loe)   empty) ;;  not rewquired after encapsulation
