...
class Bullet {
	...
	Bullet (int radius, Posn pos) {
		...
		color = Color.GREEN;
		this.pos= pos;
		this.velocity = 8; //Defined as default
...
class TestWorldExamples {
	...
	boolean testBigBang(Tester t) {
		...
		return mw1.bigBang(mw1.height, mw1.width, 1.0/1.0);
