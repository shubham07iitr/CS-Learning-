...
class Message(object):
    ...
    def shift_char(self, char, shift):
        ...
        '''
        if ord(char) + shift%95 <= 126:
            return chr(ord(char) + shift%95)
        else:
            return chr(32 + ord(char) + shift%95 - 126-1)
    ...
    def apply_pad(self, pad):
        ...
        for i in range(len(pad)):
            return_list.append(self.shift_char(char = self.input_text[i], shift = pad[i]))
...
class PlaintextMessage(Message):
    def __init__(self, input_text, pad=None):
        ...
        '''
        super().__init__(input_text=input_text)
    ...
    def generate_pad(self):
        ...
        for i in range(len(self.input_text)):
            new_pad.append(random.randint(0, 109))
        return new_pad

    def get_pad(self):
        '''
        Used to safely access your done time pad outside of the class
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        '''
        return self.apply_pad(pad = [-1*x for x in pad])
